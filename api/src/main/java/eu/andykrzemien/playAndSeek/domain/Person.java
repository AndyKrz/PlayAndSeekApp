package eu.andykrzemien.playAndSeek.domain;

import com.fasterxml.jackson.annotation.JsonIgnore;
import eu.andykrzemien.playAndSeek.domain.jpa.GenderConverter;
import lombok.*;
...
//	@Column(unique = true, length = 50)
	...
	public Person(Long id, String firstName, String lastName, String shortName, String email, String password,
				  String phone, Date birthDate, String city, Gender gender, Set<Role> roles) {
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
	...
	public static class PersonBuilder {
		...
		public Person build() {
			return new Person(id, firstName, lastName, shortName, email, password, phone, birthDate, city, gender, roles);
		}
	}
