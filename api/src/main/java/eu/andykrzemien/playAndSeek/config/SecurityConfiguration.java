package eu.andykrzemien.playAndSeek.config;

import eu.andykrzemien.playAndSeek.security.UserDetailsServiceImpl;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring()
                ...
                .antMatchers("/" + Constants.AVATAR_FOLDER + "undefined.gif")
        ;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
			...
			.authorizeRequests()
				...
				.antMatchers("/console/**").permitAll() // TODO: Enables h2 console - only for dev
